...
package com.core.animation_transitions.motion
...
import com.core.animation_transitions.motion.ui.demolist.DemoListFragment
...
class MotionMainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.motion_main_activity)
