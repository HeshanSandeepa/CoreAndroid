...
package com.core.animation_transitions.motion.demo.loading
...
import com.core.animation_transitions.motion.demo.transitionSequential
...
class LoadingActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.motion_loading_activity)
