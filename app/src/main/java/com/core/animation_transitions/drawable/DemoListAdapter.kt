...
import com.heshan.androidcore.databinding.DrawableDemoListItemBinding
...
internal class DemoViewHolder(
    ...
    inflater.inflate(R.layout.drawable_demo_list_item, parent, false)
) {
    val binding: DrawableDemoListItemBinding = DrawableDemoListItemBinding.bind(itemView)
}
